...
abstract class NetworkRepository {
  ...
  Future<Either<AppError, List<ItemVO>>> getItemListBySubCategoryId(int subId);
  Future<Either<AppError, List<EnchantmentVO>>> getItemDetailById(String itemType, int itemId);
}
