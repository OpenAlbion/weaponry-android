        ...
        builder: (context, child) {
          return Column(
            ...
            children: [
              IconAndNameSection(),
              SwitchListTile(
                title: InterText(AppLocalizations.of(context)!.dark_mode, style: TextStyle(fontSize: TEXT_REGULAR + 1)),
              ...
              Divider(height: 1, color: get80PercentColor(context).withOpacity(0.3)),
...
class BugReportSection extends StatelessWidget {
  const BugReportSection({super.key, required this.settingsController});
    ...
    return Consumer<SettingProvider>(
      builder: (context, provider, child) {
        return SwitchListTile(
          title: InterText(AppLocalizations.of(context)!.shake_to_report, style: TextStyle(fontSize: TEXT_REGULAR + 1)),
...
class ChooseServerSection extends StatelessWidget {
  const ChooseServerSection({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InterText(
                        AppLocalizations.of(context)!.market_price_server,
