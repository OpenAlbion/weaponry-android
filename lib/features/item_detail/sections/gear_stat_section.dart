...
class GearStatTitleAndDropDown extends StatelessWidget {
  const GearStatTitleAndDropDown({super.key});
                          ...
                          items: provider.selectedEnchantment.stats
                              .map(
                                (stats) => DropdownMenuItem(
                                  value: stats.quality,
                                  child: InterText(stats.quality, style: TextStyle(fontSize: TEXT_SMALL)),
                                ),
                              )
                              .toList(),
                        ),
...
class GearStatRow extends StatelessWidget {
  ...
  const GearStatRow({required this.firstStat, required this.secondStat, super.key});
    ...
    return Padding(
      ...
      child: Column(
        children: [
            ...
            children: [
              Row(
                ...
                children: [
                  SizedBox(
                    width: 100,
                    child: InterText(firstStat.name, style: TextStyle(fontSize: TEXT_SMALL)),
                  ),
                  SizedBox(
                    width: 20,
                    child: InterText(":", style: TextStyle(fontSize: TEXT_SMALL)),
                  ),
                  SizedBox(
                    width: 40,
                    child: InterText(
              ...
              Row(
                ...
                children: [
                  SizedBox(
                    width: 100,
                    child: InterText(secondStat.name, style: TextStyle(fontSize: TEXT_SMALL)),
                  ),
                  Visibility(
          ...
          Divider(color: get80PercentColor(context).withOpacity(0.3)),
        ],
      ),
    );
  }
