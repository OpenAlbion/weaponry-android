...
class ConsumableCraftingSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<CraftingProvider>(
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [InterText(AppLocalizations.of(context)!.consumer_crafting_by_product), CityDropDownSection()],
          ),
        ),
        SizedBox(height: MARGIN_MEDIUM_2),
  ...
  Widget _buildCraftingError(AppError appError) {
    return Padding(
      ...
      child: Center(
        child: InterText("${appError.code}\n${appError.message}", style: TextStyle(), textAlign: TextAlign.center),
      ),
    );
  }
}
...
class IngredientSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<CraftingProvider>(
      builder: (context, craftingProvider, child) {
...
class IngredientItemView extends StatelessWidget {
  ...
  const IngredientItemView({required this.craftingRequirementVO, super.key});
...
class ProductSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<CraftingProvider>(
      builder: (context, craftProvider, child) {
        return Consumer<ConsumableDetailProvider>(
          builder: (context, detailProvider, child) {
            ...
            items: provider.availableCityList
                .map(
                  (city) => DropdownMenuItem(
                    value: city,
                    child: InterText(city, style: TextStyle(fontSize: TEXT_SMALL)),
                  ),
                )
                .toList(),
